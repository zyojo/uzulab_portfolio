...
export const SKILLS_DATA = [
  {
    title: 'Webサイト・システム開発',
    image: WEB_ICON,
    desc: 'マルチデバイスに対応したWebサイトのデザインから実装までを一貫して行います。WordpressなどのCMSの導入や、ECサイトの立ち上げもお任せください。',
    skill: 'Javascript (React, React Native, GSAP, Three.js) / Ruby on Rails / Wordpress / EC-CUBE',
  },
  {
    title: 'グラフィックデザイン',
    image: GRAPHIC_ICON,
